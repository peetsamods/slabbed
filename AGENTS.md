...
`$HOME/CascadeProjects/Slabbed-phase19-integrate`

Do not use `$HOME/CascadeProjects/Slabbed` for new coding unless the prompt explicitly says this is archive or recovery work.
...
* root is not `$HOME/CascadeProjects/Slabbed-phase19-integrate`
