...
> **Status on this line (Fabric, Minecraft 1.21.1), 2026-09-03.** Ported as reference —
> the dy values below are version-invariant and apply here unchanged. `DySpecificationTest`,
> the enumeration test that pins this table, does not exist on this line yet; it arrives with
> the placed-height store port. Until then this file is the target, not a currently-enforced
> gate.
