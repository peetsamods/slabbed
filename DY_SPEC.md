...
- **L3 — Collision (PER-PORT ruling, NOT a universal invariant).** **This line ships
  ...
  collision follows the visual `dy`. Ruled for this line explicitly, not inherited
...
this line by explicit ruling, not inheritance (maintainer ruling, 2026-09-01). It may not go deeper without
