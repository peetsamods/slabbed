 ...
 * set). 1.21.1 Mojang mappings use {@code GuiGraphics}; text/fill are
 * {@code drawString(...)} / {@code fill(...)}.
 *
...
public final class TargetDyOverlay {
    ...
    private static void drawLine(GuiGraphics context, Minecraft client, String line, int x, int y, int color) {
