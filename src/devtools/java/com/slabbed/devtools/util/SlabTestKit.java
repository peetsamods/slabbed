...
public final class SlabTestKit {
     ...
     */
    public static final List<ResourceLocation> PALETTE = buildPalette();

    private SlabTestKit() {
    }

    private static List<ResourceLocation> buildPalette() {
    ...
    private static void add(List<ResourceLocation> ids, String id) {
    ...
    public static List<Item> resolve() {
        ...
        for (ResourceLocation id : PALETTE) {
