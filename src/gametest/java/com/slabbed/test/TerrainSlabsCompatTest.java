...
public final class TerrainSlabsCompatTest {
    ...
    // Maintainer saw with a Packed Mud TOP_LIKE slab). Pinned so a fix is a deliberate, visible flip.
    @GameTest(templateName = "fabric-gametest-api-v1:empty")
    ...
    // Fence-side fix (Maintainer's exact geometry): a fence post on a TS slab is lowered; a slab placed
