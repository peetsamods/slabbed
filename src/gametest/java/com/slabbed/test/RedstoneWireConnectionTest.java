...
/**
 * Regression matrix for GH #37 (MC 1.21.1 port of the 1.21.11 test from commit 37928aca):
 * Slabbed's redstone-wire connection override used the "can this block support dust?"
 * predicate as though it meant "should dust connect to this block?". Every ordinary full
 * cube therefore changed a vanilla {@link WireConnection#NONE} result to
 * {@link WireConnection#SIDE}.
 *
 ...
 * (1.21.1 uses the 5-arg {@code getStateForNeighborUpdate} form — house precedent in
 * {@code FencePaneSlabConnectionMixin} / {@code WallSlabConnectionMixin}.)
 */
