...
public final class SlabbedLabBeta4LiveShapeGoblinClientGameTest implements FabricClientGameTest {
    ...
    public void runTest(ClientGameTestContext ctx) {
        ...
        System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_PARITY_START]"
        ...
        try (TestSingleplayerContext singleplayer = ctx.worldBuilder()
            ...
            ctx.runOnClient(mc -> {
                if (mc.world == null) {
                    System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_STRUCTURE_INVALID] reason=client_world_missing");
                    return;
                }
                structureGreen[0] = emitStructureProof(mc.world);
            });
            if (!structureGreen[0]) {
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_PARITY_SUMMARY]"
                ...
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_DONE] status=STRUCTURE_INVALID");
                return;
            }

            syncHeldMainHand(ctx, singleplayer, new ItemStack(Items.STONE_SLAB, 16));
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_DIAG_START]"
                    + " realCrosshair=true"
                    + " syntheticUsed=false"
            ...
            RealClickResult firstSide = runRealCrosshairClick(
                    ...
                    "SLABBED_BETA4_LIVE_GOBLIN_AIM_UPPER_REAL_TARGET",
            ...
            RealClickResult lowerAfterFirst = lowerAfterFirstCorridor.found()
                    ? runRealCrosshairClick(
                            ...
                            "SLABBED_BETA4_LIVE_GOBLIN_AIM_LOWER_REAL_TARGET",
            ...
            RealClickResult topFace = runRealCrosshairClick(
                    ...
                    "SLABBED_BETA4_LIVE_GOBLIN_AIM_TOP_REAL_TARGET",
            ...
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_SUMMARY]"
            ...
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_CORRIDOR_SUMMARY]"
                    ...
                    + " wrongDelta=" + verdicts.wrongDelta
                    + " releaseBlockers=" + releaseBlockers);
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_DONE] status=OK");
        }
    }

    private static void runCompoundVisibleSlabLaneRedProof(ClientGameTestContext ctx) {
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_START]"
        ...
        try {
            ...
            ctx.runOnClient(mc -> {
                if (mc.world == null) {
                    System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_FIXTURE_FAIL]"
            ...
            if (!fixtureGreen[0]) {
                System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_SUMMARY]"
                ...
                throw new RuntimeException("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_FIXTURE_FAIL]"
    ...
    private static String runCompoundVisibleSideLaneCase(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_TRACE]"
                    + " row=" + caseName
                    + " phase=click"
    ...
    private static String runCompoundVisibleSupportMissingLaneCase(
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_SUPPORT_MISSING_TRACE]"
        ...
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_SUPPORT_MISSING_" + verdict + "]"
    ...
    private static String emitCompoundVisibleSideLaneResult(
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_SERVER_FINAL]"
                    + " row=" + caseName
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null) {
                verdict[0] = "RED";
                System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_" + caseName + "_RED]"
            ...
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_" + caseName + "_" + verdict[0] + "]"
                    + " expectedLaw=" + expectedLaw
                    + " action=" + action
                    + " expectedCandidate=" + candidate.toShortString()
    ...
    private static String emitCompoundVisibleTriadRed(
        ...
        if (!allNamedStatesGreen) {
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_TRIAD_RED]"
        ...
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_TRIAD_" + verdict + "]"
                + " expected=model_outline_raycast_target_agree_for_each_named_dy_-1.0_slab_result"
                + " lower=" + results.lower
                + " upper=" + results.upper
                + " merge=" + results.merge
    ...
    private static String emitCompoundVisibleReloadRed(
        ...
        boolean allNamedStatesGreen = "GREEN".equals(results.lower)
                ...
                && "GREEN".equals(results.supportMissing);
        if (!allNamedStatesGreen) {
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_RELOAD_RED]"
        ...
        try {
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_RELOAD_START]"
            ...
            reloadSource.getServer().runOnServer(server -> before[0] = captureReloadSnapshot(server.getOverworld(),
                    fixture));
            emitReloadSnapshot("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_RELOAD_BEFORE]", before[0], null);
            ...
            try {
                ...
                emitReloadSnapshot("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_RELOAD_AFTER]", before[0], after[0]);
                ...
                System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_RELOAD_" + verdict + "]"
                        + " expected=named_dy_-1.0_slab_states_persist_after_TestWorldSave_open"
                        + " lower=" + results.lower
                        + " upper=" + results.upper
                        + " merge=" + results.merge
            ...
            System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_RELOAD_PENDING]"
                    + " expected=named_dy_-1.0_slab_states_persist_after_reload_or_equivalent_save_load_proof"
                    + " lower=" + results.lower
                    + " upper=" + results.upper
                    + " merge=" + results.merge
    ...
    private static String compoundVisibleReleaseBlockers(CompoundVisibleSlabLaneResults results) {
        if ("GREEN".equals(results.reload)
            ...
            return "the maintainerLiveRetest";
        }
        if ("GREEN".equals(results.reload) && "PARTIAL".equals(results.triad)) {
            return "modelAuthority/manualVisual,the maintainerLiveRetest";
        }
        if ("RED".equals(results.reload)) {
            return "reload,model/manualVisual,the maintainerLiveRetest";
        }
        if ("PENDING".equals(results.reload)) {
            return "reloadHarness,model/manualVisual,the maintainerLiveRetest";
        }
    ...
    private static NamedCompoundVisibleLaneFixture buildCompoundVisibleNamedStateFixture(
        ...
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_NAMED_FIXTURE]"
                + " purpose=" + purpose
    ...
    private static TriadProof proveCompoundVisibleTriad(
        ...
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_MODEL_AUTHORITY_"
    ...
    private static TriadSurface proveTriadSurface(
        ...
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_TRIAD_CASE]"
                + " caseName=" + name
        ...
        System.out.println("[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_MODEL_AUTHORITY_CASE]"
                + " caseName=" + name
                + " pos=" + pos.toShortString()
                + " state=" + state
                + " marker=" + markerName
    ...
    private static RealClickResult runRealCrosshairClick(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.world == null || mc.interactionManager == null) {
                ...
                click[0].result = "RED";
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_AIM_PARITY_FAIL]"
            ...
            if ("REPEAT".equals(step) && repeatSeamTraceEnabled()) {
                ...
                System.out.println("[SLABBED_BETA4_REPEAT_SEAM_CLIENT_RESULT]"
        ...
        ctx.runOnClient(mc -> {
            ...
            String marker = switch (step) {
                case "FIRST_SIDE" -> "[SLABBED_BETA4_LIVE_GOBLIN_SEQUENCE_FIRST_SIDE]";
                case "LOWER_AFTER_FIRST" -> "[SLABBED_BETA4_LIVE_GOBLIN_SEQUENCE_LOWER_AFTER_FIRST]";
                case "REPEAT" -> "[SLABBED_BETA4_LIVE_GOBLIN_SEQUENCE_REPEAT]";
                case "TOP_FACE" -> "[SLABBED_BETA4_LIVE_GOBLIN_SEQUENCE_TOP_FACE]";
                default -> "[SLABBED_BETA4_LIVE_GOBLIN_SEQUENCE]";
            };
            System.out.println(marker
            ...
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_DELTA_SCAN]"
                    + " step=" + step
                    + " " + delta.describe);
            if ("REPEAT".equals(step) && repeatSeamTraceEnabled()) {
                ...
                System.out.println("[SLABBED_BETA4_REPEAT_SEAM_SUMMARY]"
    ...
    private static void emitRepeatClientBefore(
        ...
        System.out.println("[SLABBED_BETA4_REPEAT_SEAM_START]"
                + " mode=finalization_fix"
                + " gameplayChange=true"
                + " target=" + expectedChangedPos.toShortString()
                + " expected=" + expectedChangedState);
        System.out.println("[SLABBED_BETA4_REPEAT_SEAM_CLIENT_BEFORE]"
                ...
                + " visualLocalY=" + facts.visualLocalY
                + " heldItem=" + held);
        System.out.println("[SLABBED_BETA4_REPEAT_SEAM_CLIENT_PREDICT]"
                + " target=" + expectedChangedPos.toShortString()
    ...
    private static void emitRepeatSeamServerTick(
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println("[SLABBED_BETA4_REPEAT_SEAM_SERVER_TICK]"
                    + " tick=" + tick
    ...
    private static void emitRepeatSeamClientTick(ClientGameTestContext ctx, int tick, BlockPos target) {
        ctx.runOnClient(mc -> {
            if (mc.world == null) {
                System.out.println("[SLABBED_BETA4_REPEAT_SEAM_CLIENT_TICK]"
                        + " tick=" + tick
                        + " target=" + target.toShortString()
    ...
    private static RealClickResult noCorridorClick(String step, AimCorridor corridor) {
        ...
        System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_LOWER_CORRIDOR_SEQUENCE]"
                + " step=" + step
                + " result=NO_CORRIDOR"
                + " selected=false"
    ...
    private static void emitLegacySequenceStale(ParityVerdicts verdicts) {
        System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_LEGACY_SEQUENCE_STALE]"
                ...
                + " lowerAfterFirst=" + verdicts.lowerAfterFirst
                + " repeatPlacement=" + verdicts.repeatPlacement
                + " releaseBlockers=the maintainerLiveRetest");
    }
    ...
    private static boolean proveFreshStructure(ClientGameTestContext ctx, TestSingleplayerContext singleplayer) {
        ...
        if (!green[0]) {
            throw new RuntimeException("[SLABBED_BETA4_LIVE_GOBLIN_STRUCTURE_INVALID] reason=fixture_truth_not_proven");
        }
        return green[0];
    }
    ...
    private static String runSideCase(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.world == null || mc.interactionManager == null) {
                throw new RuntimeException("[SLABBED_BETA4_LIVE_GOBLIN_STRUCTURE_INVALID] case="
            ...
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TRACE]"
                    + " case=" + caseName
                    + " phase=click"
                    + " expectedOwner=" + UPPER_FULL.toShortString()
                    + " actualTarget=" + describeHit(beforeTarget)
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_" + caseName + "_" + verdict[0] + "]"
            ...
            if ("SUPPORT_PRESENT_SIDE_LOWER".equals(caseName)) {
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_SIDE_LOWER_EXACT_" + verdict[0] + "]"
                ...
                if (wrongUpperForLower) {
                    System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_SIDE_LOWER_WRONG_RESULT_RED]"
                ...
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_SIDE_UPPER_FIRST_" + verdict[0] + "]"
                        + " clickedSource=" + describeBlock(mc.world, UPPER_FULL)
                        + " hitFace=" + hit.getSide().asString()
                        + " hitY=" + hit.getPos().y
                        + " hitBand=" + hitBand(hit)
    ...
    private static String runRepeatPlacementCase(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.world == null || mc.interactionManager == null) {
                throw new RuntimeException("[SLABBED_BETA4_LIVE_GOBLIN_REPEAT_PLACEMENT_RED]"
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null) {
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_REPEAT_PLACEMENT_RED]"
            ...
            verdicts.observedCases++;
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_REPEAT_PLACEMENT_" + verdict[0] + "]"
                    + " firstAction=" + firstAction[0]
                    + " secondAction=" + secondAction[0]
                    + " clickedSource=" + describeBlock(mc.world, UPPER_FULL)
    ...
    private static String runTopFaceCase(
        ...
        ctx.runOnClient(mc -> {
            ...
            if ("SUPPORT_PRESENT_TOP_FACE".equals(caseName) && !legalTop && ghostOrSkip) {
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TOP_FACE_WRONG_RESULT_RED]"
    ...
    private static String runSupportMissingSideCase(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.world == null || mc.interactionManager == null) {
                throw new RuntimeException("[SLABBED_BETA4_LIVE_GOBLIN_" + caseName
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null) {
                verdict[0] = "RED";
                System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_" + caseName
    ...
    private static void removeSupportUnderUpperFullBlock(TestSingleplayerContext singleplayer) {
        singleplayer.getServer().runOnServer(server -> {
            ...
            world.breakBlock(TOP_SLAB_A, false);
            world.updateNeighborsAlways(TOP_SLAB_A, Blocks.AIR, null);
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_SUPPORT_MISSING_SETUP]"
                    + " missingUnderSlabVariantTested=true"
                    + " missingUnderSlabVariantSupportPos=" + TOP_SLAB_A.toShortString()
                    + " removedSupport=" + describeBlock(world, TOP_SLAB_A)
    ...
    private static boolean emitStructureProof(net.minecraft.world.BlockView world) {
        ...
        String marker = bottomA && bottomB && bridgeA && bridgeB && topA && topB && upper
                ...
                ? "[SLABBED_BETA4_LIVE_GOBLIN_STRUCTURE_GREEN]"
                : "[SLABBED_BETA4_LIVE_GOBLIN_STRUCTURE_INVALID]";
        System.out.println(marker
    ...
    private static boolean emitCompoundVisibleSlabLaneFixtureProof(net.minecraft.world.BlockView world) {
        ...
        boolean green = bottomA && bottomB && bridgeA && bridgeB && topA && topB && upper
                && sideCandidateEmpty && topFaceCandidateEmpty && skippedTopCandidateEmpty && missingVariantNamed;
        String marker = green
                ? "[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_FIXTURE_GREEN]"
                : "[SLABBED_BETA4_COMPOUND_VISIBLE_SLAB_LANE_FIXTURE_FAIL]";
        System.out.println(marker
    ...
    private static AimCorridor scanAimCorridors(
        ...
        System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_AIM_CORRIDOR_START]"
                + " caseName=" + caseName
        ...
        for (int i = 0; i < candidates.length; i++) {
            ...
            ctx.runOnClient(mc -> {
                if (mc.player == null || mc.world == null) {
                    ...
                    System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_AIM_CORRIDOR_CANDIDATE]"
                            + " caseName=" + caseName
                            + " cameraIndex=" + index
        ...
        if (selected != null) {
            System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_AIM_CORRIDOR_SELECTED]"
                    + " caseName=" + caseName
        ...
        System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_AIM_CORRIDOR_NONE]"
                + " caseName=" + caseName
                + " intendedOwnerPos=" + UPPER_FULL.toShortString()
                + " intendedFace=" + face.asString()
                + " intendedVisualLocalY=" + visualLocalY
    ...
    private static void emitTargetingDiagnostic(String step, String expectedBand, TargetingDiagnostic diagnostic) {
        String markers = switch (expectedBand) {
            case "LOWER" -> "[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_LOWER_DIAG]";
            case "UPPER" -> "[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_UPPER_DIAG]";
            case "TOP" -> "[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_TOP_DIAG]";
            default -> "[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_DIAG]";
        };
        markers = switch (step) {
            case "FIRST_SIDE" -> markers + "\n[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_SEQUENCE_FIRST_DIAG]";
            case "LOWER_AFTER_FIRST" -> markers + "\n[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_SEQUENCE_LOWER_AFTER_FIRST_DIAG]";
            case "TOP_FACE" -> markers + "\n[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_SEQUENCE_TOP_DIAG]";
            default -> markers;
        };
        ...
        switch (diagnostic.classification) {
            case "HARNESS_AIM_FAIL" -> System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_HARNESS_AIM_FAIL]"
                    + " step=" + step + " reason=" + diagnostic.reason);
            case "OWNER_FAIL" -> System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_OWNER_FAIL]"
                    + " step=" + step + " reason=" + diagnostic.reason);
            case "OCCLUSION_EXPECTED" -> System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_OCCLUSION_EXPECTED]"
                    + " step=" + step + " reason=" + diagnostic.reason);
            case "SEQUENCE_STATE_MISMATCH" -> System.out.println("[SLABBED_BETA4_LIVE_GOBLIN_TARGETING_SEQUENCE_STATE_MISMATCH]"
                    + " step=" + step + " reason=" + diagnostic.reason);
            default -> {
            }
        }
