...
public final class SlabbedLabLoweredSidePlacementLiveReproClientGameTest implements FabricClientGameTest {
     ...
     *
     * <p>the maintainer's manual live test (MC 1.21.11) shows torches and items floating or
     * failing to anchor on slab-supported geometry. The prior Beta 3.5 triad proof
     * ({@code SLABBED_BETA35_OBJECT_SLAB_TRIAD_SUMMARY}) proved only owner-route
     ...
     * </ul>
     *
     * <p>The SUMMARY marker deliberately emits RED ({@code liveResult=RED})
    ...
    private static void runBeta35LiveItemAnchoringRedProof(
        ...
        //   a) the maintainer's live test with player-initiated placement fails.
        ...
        System.out.println("[SLABBED_BETA35_LIVE_ITEM_ANCHORING_RED]"
                + " fixtureResult=" + (fixtureCanPlace && fixturePlaced && fixtureAnchorDyOk && fixtureSurvived
                        ? "FIXTURE_PASS_LIVE_FAIL" : "FIXTURE_FAIL")
                + " failureLayer=" + failureLayer
                + " the maintainerReport=torches_and_items_floating_or_not_anchoring_on_slab_supported_geometry"
