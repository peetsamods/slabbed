...
public final class SlabbedLabLoweredSidePlacementLiveReproClientGameTest implements FabricClientGameTest {
    ...
    private static void runthe maintainerBeta4AboveAngleTargetingOwnerSplitRedCase(
        ...
        runthe maintainerBeta4AngleTargetingProbe(
                ctx,
                singleplayer,
                "ground_front",
                supportPos,
    ...
    private static void runthe maintainerBeta4AngleTargetingProbe(
            ClientGameTestContext ctx,
            TestSingleplayerContext singleplayer,
            String angle,
            BlockPos supportPos,
    ...
    private static void runthe maintainerBeta4AngleTargetingProbe(
        ...
        ctx.runOnClient(mc -> {
            ...
            if (expectGreen && expectedOwner.equals(finalOwner)) {
                System.out.println("[SLABBED_BETA4_ABOVE_ANGLE_GREEN]" + facts);
                return;
            }
            ...
            throw new RuntimeException("[SLABBED_BETA4_ABOVE_ANGLE_RED]" + facts
