...
public final class SlabbedLabLoweredSidePlacementLiveReproClientGameTest implements FabricClientGameTest {
    ...
    private static void runBeta4LiveScreenshotShapeRedProof(
        ...
        System.out.println("[MAINTAINER_BETA4_LIVE_SCREENSHOT_HARNESS_GREEN]"
                + " classification=UNEXPECTED_GREEN"
                + " reason=screenshot_shape_no_longer_reproduces_manual_failure");
        throw new RuntimeException("Maintainer beta4 live screenshot shape unexpectedly went green; do not save as RED proof");
    }
    ...
    private static void runCompoundSlabNoLegalLaneCase(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA4_COMPOUND_BELOW_LANE_SIDE_SLAB_GREEN]"
                    + " row=" + rowName
                    + " half=" + halfLabel
                    + " classification=COMPOUND_BELOW_LANE_SIDE_SLAB"
                    + " compound=" + describeOwnerFacts(mc.world, compoundPos)
