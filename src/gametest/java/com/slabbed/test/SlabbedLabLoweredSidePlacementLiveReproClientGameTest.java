...
public final class SlabbedLabLoweredSidePlacementLiveReproClientGameTest implements FabricClientGameTest {
    ...
    public void runTest(ClientGameTestContext ctx) {
        ...
        if (Boolean.getBoolean("slabbed.beta4SeamVisibleUpperRedOnly")) {
            try (TestSingleplayerContext singleplayer = ctx.worldBuilder()
                    .setUseConsistentSettings(true)
                    .create()) {
                runMaintainerBeta4AboveAngleTargetingOwnerSplitRedCase(ctx, singleplayer, false);
            }
            return;
        }
        ...
        if (Boolean.getBoolean("slabbed.beta4SeamGreenProofsOnly")) {
            try (TestSingleplayerContext singleplayer = ctx.worldBuilder()
                    .setUseConsistentSettings(true)
                    .create()) {
                runMaintainerBeta4StoneSlabTargetingOutlineMismatchRedCase(ctx, singleplayer);
                runMaintainerBeta4AdjacentVisibleTargetRedCase(ctx, singleplayer);
        ...
        if (Boolean.getBoolean("slabbed.maintainerBeta4AdjacentVisibleRedOnly")) {
            try (TestSingleplayerContext singleplayer = ctx.worldBuilder()
                    .setUseConsistentSettings(true)
                    .create()) {
                runMaintainerBeta4AdjacentVisibleTargetRedCase(ctx, singleplayer);
        ...
        if (Boolean.getBoolean("slabbed.maintainerBeta4AboveAngleRedOnly")) {
            try (TestSingleplayerContext singleplayer = ctx.worldBuilder()
                    .setUseConsistentSettings(true)
                    .create()) {
                runMaintainerBeta4AboveAngleTargetingOwnerSplitRedCase(ctx, singleplayer);
            }
            return;
        }

        if (Boolean.getBoolean("slabbed.maintainerBeta4TargetingRedOnly")) {
            try (TestSingleplayerContext singleplayer = ctx.worldBuilder()
                    .setUseConsistentSettings(true)
                    .create()) {
                runMaintainerBeta4StoneSlabTargetingOutlineMismatchRedCase(ctx, singleplayer);
    ...
    private static void runBeta4LiveScreenshotShapeRedProof(
        ...
        if (redSummary.length() > 0) {
            ...
            System.out.println("[MAINTAINER_BETA4_LIVE_SCREENSHOT_BAND_SPLIT_HARNESS_GREEN]"
                    + " classification=EXPECTED_RED_AUDIT"
                    + " summary=" + summary.replace('\n', '|'));
            System.out.println("[MAINTAINER_BETA4_LIVE_SCREENSHOT_HARNESS_GREEN]"
                    + " classification=EXPECTED_RED_AUDIT"
                    + " summary=" + summary.replace('\n', '|'));
            return;
        }
    ...
    private static void runBeta35ObjectSlabOwnershipProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_TORCH_TARGET_RED] client not ready");
            }
            ...
            if (!torchState.isOf(Blocks.TORCH)) {
                throw new RuntimeException("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_TORCH_TARGET_RED]"
                        + " expected torch at " + torchPos.toShortString()
                        + " found=" + torchState);
            }
            if (!slabState.isOf(Blocks.STONE_SLAB)) {
                throw new RuntimeException("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_SLAB_TARGET_RED]"
            ...
            System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_FIXTURE_GREEN]"
            ...
            System.out.println((torchGreen
                    ? "[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_TORCH_TARGET_GREEN]"
                    : "[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_TORCH_TARGET_RED]")
                    + " expectedOwner=torch"
            ...
            System.out.println((slabGreen
                    ? "[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_SLAB_TARGET_GREEN]"
                    : "[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_SLAB_TARGET_RED]")
                    + " expectedOwner=slab"
            ...
            if (ownerRouteGreen) {
                System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_OWNER_ROUTE_GREEN]"
                        + " proofScope=" + ownerRouteScope
            ...
            boolean raycastGreen = objectRaycastHit != null
                    ...
                    && torchGreen;
            System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_FIXTURE_GREEN]"
                    + " objectPos=" + torchPos.toShortString()
                    + " objectState=" + torchState
                    + " objectDy=" + String.format("%.3f", torchDy)
            ...
            System.out.println((outlineColocatedWithModel
                    ? "[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_MODEL_OUTLINE_GREEN]"
                    : "[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_MODEL_OUTLINE_RED]")
            ...
            System.out.println((raycastGreen
                    ? "[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_RAYCAST_GREEN]"
                    : "[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_RAYCAST_RED]")
            ...
            if (ownerRouteGreen && !outlineColocatedWithModel) {
                System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_FALSE_GREEN]"
                        + " oldOwnerOnlyProof=GREEN"
            ...
            System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_SURVIVAL_GREEN]"
                    + " objectPos=" + torchPos.toShortString()
                    + " objectState=" + torchState
                    + " supportPos=" + slabPos.toShortString()
                    + " supportState=" + slabState
                    + " survival=" + survival);
            System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_SUMMARY]"
                    + " proofScope=" + ownerRouteScope
                    + " objectClass=torch"
            ...
            System.out.println("[MAINTAINER_BETA35_OBJECT_SLAB_TRIAD_SUMMARY]"
            ...
            if (!survival) {
                throw new RuntimeException("[MAINTAINER_BETA35_OBJECT_SLAB_OWNERSHIP_SURVIVAL_RED]"
    ...
    private static void runBeta4LiveScreenshotSideSlabBandCase(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA4_LIVE_SCREENSHOT_HARNESS_FAIL] case="
            ...
            emitCompoundSlabDiscriminator(
                    "[MAINTAINER_BETA4_LIVE_SCREENSHOT_DISCRIMINATOR]",
                    proof,
                    mc.world,
                    clickedTopFullPos,
                    face,
        ...
        ctx.runOnClient(mc -> {
            ...
            if (!expectedLegalSideSlab) {
                ...
                String marker = requireGreen
                        ? "[MAINTAINER_BETA4_LIVE_SCREENSHOT_SIDE_UPPER_GREEN]"
                        : "[MAINTAINER_BETA4_LIVE_SCREENSHOT_SIDE_LOWER_GREEN]";
        ...
        ctx.runOnClient(mc -> {
            ...
            if (!expectedLegalTopSlab) {
                String reason = "case=" + proof
                        ...
                        + " clicked=" + describeOwnerFacts(mc.world, clickedTopFullPos)
                        + " loweredLaneBelowTop=" + describeOwnerFacts(mc.world, loweredLaneBelowTop);
                System.out.println("[MAINTAINER_BETA4_LIVE_SCREENSHOT_TOP_FACE_GHOST_RED] " + reason);
                redSummary.append(reason).append('\n');
            } else {
                System.out.println("[MAINTAINER_BETA4_LIVE_SCREENSHOT_TOP_FACE_GHOST_GREEN]"
                        + " result=" + resultText[0]
                        + " resultWasPass=" + resultWasPass
                        + " sourceFace=" + topHit.getSide().asString()
                        + " hitY=" + topHit.getPos().y
    ...
    private static void assertBeta4LiveScreenshotSourceTruth(
        ...
        if (!clicked.isOf(Blocks.STONE)
            ...
            throw new RuntimeException("[MAINTAINER_BETA4_LIVE_SCREENSHOT_HARNESS_FAIL]"
                    + " case=" + proof
    ...
    private static void runCompoundSlabNoLegalLaneCase(
        ...
        ctx.runOnClient(mc -> {
            ...
            emitCompoundSlabDiscriminator(
                    "[MAINTAINER_BETA4_NO_LEGAL_LANE_DISCRIMINATOR]",
                    rowName + "-" + halfLabel,
                    mc.world,
                    compoundPos,
                    face,
            ...
            System.out.println("[MAINTAINER_BETA4_COMPOUND_BELOW_LANE_SIDE_SLAB_ATTEMPT]"
                    + " row=" + rowName
                    + " half=" + halfLabel
                    + " result=" + result
                    + " sourceDy=" + sourceDy
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println((visibleUpperBand
                    ? "[MAINTAINER_BETA4_COMPOUND_OLD_ROW_VISIBLE_UPPER_SUPERSEDED_GREEN]"
                    : "[MAINTAINER_BETA4_COMPOUND_BELOW_LANE_SIDE_SLAB_GREEN]")
                    + " row=" + rowName
                    + " half=" + halfLabel
                    + " classification=" + expectedLaw
                    + " visibleLocalY=" + visibleLocalY
    ...
    private static void runCompoundSlabAdjacentLaneCase(
        ...
        ctx.runOnClient(mc -> {
            ...
            emitCompoundSlabDiscriminator(
                    "[MAINTAINER_BETA4_INTERNAL_ROW3_DISCRIMINATOR]",
                    rowName,
                    mc.world,
                    compoundPos,
                    face,
                    ...
                    true);
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, hit);
            System.out.println("[MAINTAINER_BETA4_COMPOUND_SLAB_LEGAL_REMAP_PENDING]"
                    + " row=" + rowName
                    + " phase=post-click"
                    + " result=" + result
                    + " compound=" + describeOwnerFacts(mc.world, compoundPos)
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA4_COMPOUND_SLAB_LEGAL_REMAP_GREEN]"
                    + " row=" + rowName
                    + " phase=after-tick"
                    + " compound=" + describeOwnerFacts(mc.world, compoundPos)
                    + " adjacentLegalLane=" + describeOwnerFacts(mc.world, adjacentLanePos)
    ...
    private static void runCompoundSlabMergePendingNote(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA4_COMPOUND_SLAB_DOUBLE_MERGE_PENDING]"
                    + " row=" + rowName
                    + " face=" + face.asString()
                    + " compound=" + describeOwnerFacts(mc.world, compoundPos)
                    + " adjacent=" + describeOwnerFacts(mc.world, adjacentLanePos)
    ...
    private static void runCompoundSlabSanityNote(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA4_COMPOUND_BELOW_LANE_SIDE_SLAB_PENDING]"
                    + " row=" + rowName
    ...
    private static void assertCompoundSlabHarnessTopology(
        ...
        ctx.runOnClient(mc -> {
            ...
            if (expectLegalLane) {
                ...
                System.out.println("[MAINTAINER_BETA4_COMPOUND_SLAB_HARNESS_SOURCE_GREEN]"
                        + " row=" + rowName
    ...
    private static void failCompoundSlabHarness(String rowName, String reason) {
        System.out.println("[MAINTAINER_BETA4_COMPOUND_SLAB_HARNESS_FAIL]"
                + " row=" + rowName
                + " reason=" + reason);
    ...
    private static void runMaintainerBeta4StoneSlabTargetingOutlineMismatchRedCase(
            ClientGameTestContext ctx,
            TestSingleplayerContext singleplayer
    ) {
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA4_TARGETING] shape=compact_lowered_stone_with_upper_double_slab"
            ...
            if (expectedOwner.equals(vanillaOwner) && !expectedOwner.equals(finalOwner)) {
                throw new RuntimeException("[MAINTAINER_BETA4_TARGETING_RED]"
                        + " expectedOwner=" + expectedOwner
                        + " visibleOwner=" + visibleOwner
                        + " vanillaTarget=" + describeHit(vanilla)
                        + " finalTarget=" + describeHit(finalTarget)
            ...
            if (expectedOwner.equals(vanillaOwner) && expectedOwner.equals(finalOwner)) {
                System.out.println("[BETA4_ANCHORED_UP_PRESERVE_GREEN]"
                        ...
                        + " expectedFacts=" + describeOwnerFacts(mc.world, expectedOwnerPos)
                        + " visibleFacts=" + describeOwnerFacts(mc.world, visibleSlabOwnerPos));
                System.out.println("[MAINTAINER_BETA4_TARGETING_GREEN]"
                        + " expectedOwner=" + expectedOwner
                        + " visibleOwner=" + visibleOwner
                        + " vanillaTarget=" + describeHit(vanilla)
                        + " finalTarget=" + describeHit(finalTarget)
            ...
            throw new RuntimeException("[MAINTAINER_BETA4_TARGETING_PROOF_GAP]"
                    + " expectedOwner=" + expectedOwner
                    + " visibleOwner=" + visibleOwner
                    + " vanillaTarget=" + describeHit(vanilla)
                    + " finalTarget=" + describeHit(finalTarget)
    ...
    private static void runMaintainerBeta4AboveAngleTargetingOwnerSplitRedCase(
            ClientGameTestContext ctx,
            TestSingleplayerContext singleplayer
    ) {
        runMaintainerBeta4AboveAngleTargetingOwnerSplitRedCase(ctx, singleplayer, true);
    }
    ...
    private static void runMaintainerBeta4AboveAngleTargetingOwnerSplitRedCase(
        ...
        if (includeGroundControl) {
            red = runMaintainerBeta4AngleTargetingProbe(
                    ctx,
                    singleplayer,
                    "ground_front",
                    supportPos,
    ...
    private static String runMaintainerBeta4AngleTargetingProbe(
            ClientGameTestContext ctx,
            TestSingleplayerContext singleplayer,
            String angle,
            BlockPos supportPos,
        ...
        float yaw = (float) Math.toDegrees(Math.atan2(-delta.x, delta.z));
        float pitch = (float) (-Math.toDegrees(Math.atan2(delta.y, horiz)));
        return runMaintainerBeta4AngleTargetingProbe(
                ctx,
                singleplayer,
                angle,
                supportPos,
    ...
    private static String runMaintainerBeta4AngleTargetingProbe(
        ...
        ctx.runOnClient(mc -> {
            ...
            String facts = " shape=compact_lowered_stone_with_upper_double_slab"
                ...
                System.out.println("[MAINTAINER_BETA4_ABOVE_ANGLE]" + facts);
            ...
            if (expectedVisibleOwnerHit) {
                ...
                System.out.println("[MAINTAINER_BETA4_SCREENSHOT_INTENT_GREEN]" + facts);
                return;
            }
            ...
            if (anchoredOwnerWon) {
                ...
                System.out.println(redMessage[0]);
                System.out.println("[MAINTAINER_BETA4_SCREENSHOT_INTENT_RED]" + facts
                        + " suspectedFailingLayer=anchored-owner-preserved-over-visible-owner"
                        + " anchoredOwnerWon=true"
                        + " groundAngleExpectedGreen=" + expectGreen);
                return;
    ...
    private static void runMaintainerBeta4AdjacentVisibleTargetRedCase(
            ClientGameTestContext ctx,
            TestSingleplayerContext singleplayer
    ) {
        final BlockPos supportPos = SUPPORT_POS.add(24, 0, 0);
        ...
        ctx.runOnClient(mc -> {
            ...
            if (adjacentOwnerWon) {
                ...
                System.out.println("[MAINTAINER_BETA4_ADJACENT_VISIBLE_GREEN]" + facts);
                return;
            }

            throw new RuntimeException("[MAINTAINER_BETA4_ADJACENT_VISIBLE_RED]" + facts
    ...
    private static void runBeta35LiveItemAnchoringRedProof(
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println("[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_FIXTURE_GREEN]"
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_PLACEMENT_RED]"
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println((placementOk
                    ? "[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_PLACEMENT_GREEN]"
                    : "[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_PLACEMENT_RED]")
                    + " categoryScope=floor_torch_only"
                    + " supportPos=" + slabPos.toShortString()
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println((torchSurvivedNeighborUpdate[0]
                    ? "[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_SURVIVAL_GREEN]"
                    : "[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_SURVIVAL_RED]")
                    + " categoryScope=floor_torch_only"
                    + " supportPos=" + slabPos.toShortString()
                    + " supportState=" + world.getBlockState(slabPos)
                    + " supportDy=" + String.format("%.3f", slabDyResult[0])
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_TRIAD_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            BlockState torchState = mc.world.getBlockState(torchPos);
            BlockState slabState = mc.world.getBlockState(slabPos);
            ...
            System.out.println((triadGreenResult[0]
                    ? "[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_TRIAD_GREEN]"
                    : "[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_TRIAD_RED]")
                    + " categoryScope=floor_torch_only"
                    + " supportPos=" + slabPos.toShortString()
                    + " supportState=" + slabState
                    + " supportDy=" + String.format("%.3f", slabDyResult[0])
        ...
        System.out.println("[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_SUMMARY]"
                ...
                + " maintainerLiveResult=" + (failureLayer.equals("NONE") ? "GREEN_FLOOR_TORCH_ONLY" : "RED")
                + " failureLayer=" + failureLayer
                + " beta35ReleaseStatus=PAUSED_PENDING_MAINTAINER_SCOPE_DECISION"
                + " priorTriadProofStatus=INCLUDE_READY_TRIAD_ONLY");

        if (!failureLayer.equals("NONE")) {
            throw new RuntimeException("[MAINTAINER_BETA35_LIVE_ITEM_ANCHORING_RED]"
                    + " failureLayer=" + failureLayer
                    + " categoryScope=floor_torch_only"
                    + " placementResult=" + placementResultText[0]
                    + " finalState=" + finalStateText[0]);
    ...
    private static void runBeta35FloorTorchLiveShapeRedProof(
        ...
        singleplayer.getServer().runOnServer(server -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_FIXTURE_GREEN]"
                    + " categoryScope=floor_torch_only"
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_CONTACT_MEASURED]"
                    + " categoryScope=floor_torch_only"
                    + " fixtureShape=beta4_live_screenshot_seed_plus_floor_torch_lane"
                    + " expectedTorchPos=" + expectedTorchPos.toShortString()
            ...
            String statusMarker = switch (liveShapeProofStatus) {
                case "RED" -> "[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_RED]";
                case "GREEN" -> "[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_GREEN]";
                default -> "[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_PENDING]";
            };

            System.out.println(statusMarker
                    + " categoryScope=floor_torch_only"
                    + " maintainerManualVisualVerdict=NOT_ACCEPTED"
                    + " fixtureShape=beta4_live_screenshot_seed_plus_floor_torch_lane"
                    + " placementResult=" + placementResultText[0]
                    + " placementAccepted=" + placementAccepted[0]
                    + " expectedTorchPos=" + expectedTorchPos.toShortString()
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LIVE_SHAPE_SUMMARY]"
                    + " categoryScope=floor_torch_only"
                    + " itemCategory=floor_torch"
                    + " wall_torch=NOT_COVERED"
                    + " lantern=NOT_COVERED"
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_CONTACT_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " itemCategory=floor_torch"
                + " wall_torch=NOT_COVERED"
                + " lantern=NOT_COVERED"
        ...
        if (!loweredSlabContactGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_CONTACT_RED]"
                    + " categoryScope=floor_torch_only"
                    + " caseAFailureLayer=" + loweredCaseA.failureLayer()
                    + " caseBFailureLayer=" + loweredCaseB.failureLayer());
        }
    ...
    private static Beta35LoweredSlabContactAttempt runBeta35FloorTorchLoweredSlabContactAttempt(
        ...
        ctx.runOnClient(mc -> {
            ...
            String liveCaptureMarker = failureLayer.equals("NONE")
                    ? "[MAINTAINER_BETA35_LIVE_TORCH_CAPTURE_GREEN]"
                    : "[MAINTAINER_BETA35_LIVE_TORCH_CAPTURE_RED]";
            String loweredSlabContactMarker = failureLayer.equals("NONE")
                    ? "[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_CONTACT_GREEN]"
                    : "[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_CONTACT_RED]";
    ...
    private static void runBeta35FloorTorchVisualContactRedProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_VISUAL_CONTACT_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
            placementResultText[0] = result.toString();
        ...
        ctx.runOnClient(mc -> {
            ...
            if (!placementAccepted[0] || !torchState.isOf(Blocks.TORCH)) {
                marker = "[MAINTAINER_BETA35_FLOOR_TORCH_VISUAL_CONTACT_RED]";
                visualStatus = "RED";
                ...
                marker = "[MAINTAINER_BETA35_FLOOR_TORCH_VISUAL_CONTACT_PENDING]";
                visualStatus = "PENDING";
                failureLayer = "FIXTURE_MISMATCH";
            }

            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_CONTACT_GAP_MEASURED]"
                    + " categoryScope=floor_torch_only"
                    + " supportPos=" + supportPos.toShortString()
                    + " supportState=" + supportState
                    + " supportDy=" + String.format("%.3f", supportDy)
            ...
            System.out.println(marker
                    ...
                    + " failureLayer=" + failureLayer);
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_VISUAL_SUMMARY]"
                    + " categoryScope=floor_torch_only"
                    + " itemCategory=floor_torch"
                    + " wall_torch=NOT_COVERED"
                    + " lantern=NOT_COVERED"
    ...
    private static void runBeta35FloorTorchV2ContactGapRedProof(
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_GAP_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " itemCategory=floor_torch"
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_FIX_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " itemCategory=floor_torch"
                + " wall_torch=NOT_COVERED"
    ...
    private static Beta35V2ContactGapAttempt runBeta35FloorTorchV2ContactGapRedAttempt(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_GAP_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
            placementResultText[0] = result.toString();
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_V2_COORDINATE_REPLAY]"
                    + " categoryScope=floor_torch_only"
                    + " caseName=" + scenario
                    ...
                    + " failureLayer=" + failureLayer);
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_GAP_MEASURED]"
                    + " categoryScope=floor_torch_only"
                    + " caseName=" + scenario
                    + " supportCandidatePos=" + supportCandidatePos.toShortString()
                    + " supportCandidateState=" + supportCandidateState
                    ...
                    + " placementResult=" + placementResultText[0]
                    + " placementAccepted=" + placementAccepted[0]);
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_GAP_RED]"
                    + " categoryScope=floor_torch_only"
                    + " caseName=" + scenario
                    + " supportCandidatePos=" + supportCandidatePos.toShortString()
                    + " supportCandidateState=" + supportCandidateState
            ...
            String fixMarker = legalRejectObserved
                    ? "[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_FIX_REJECT_GREEN]"
                    : "[MAINTAINER_BETA35_FLOOR_TORCH_V2_CONTACT_FIX_GREEN]";
    ...
    private static void runBeta35FloorTorchLoweredSlabPlacementProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_PLACEMENT_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_PLACEMENT_MEASURED]"
                    + " categoryScope=floor_torch_only"
            ...
            if (failureLayer.equals("NONE")) {
                System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_PLACEMENT_GREEN]"
                        + " categoryScope=floor_torch_only"
                        + " intendedSupportCandidateState=" + supportCandidateState
                        + " intendedSupportDy=" + String.format("%.6f", supportDy)
                        + " finalInteractResult=" + finalInteractResult[0]
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_LOWERED_SLAB_PLACEMENT_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " failureLayer=" + failureLayerHolder[0]
    ...
    private static void runBeta35FloorTorchPlainBottomContactProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_PLAIN_BOTTOM_CONTACT_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
            finalInteractResult[0] = result.toString();
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_LIVE_TORCH_EXISTING_CONTACT]"
                    + " torchPos=" + torchPos.toShortString()
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_PLAIN_BOTTOM_CONTACT_MEASURED]"
                    + " categoryScope=floor_torch_only"
                    + " heldItem=minecraft:torch"
                    + " crosshairTargetPos=" + supportCandidatePos.toShortString()
                    + " crosshairTargetFace=UP"
            ...
            if (failureLayer.equals("NONE")) {
                System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_PLAIN_BOTTOM_CONTACT_GREEN]"
                        + " categoryScope=floor_torch_only"
                        + " supportCandidateState=" + supportState
                        + " supportSourceType=PLAIN_STATE"
                        + " supportDy=" + supportDyText[0]
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_PLAIN_BOTTOM_CONTACT_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " failureLayer=" + failureLayerHolder[0]
    ...
    private static void runBeta35FloorTorchFullBlockContactRedProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_CONTACT_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
            placementResultText[0] = result.toString();
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_CONTACT_MEASURED]"
                    + " categoryScope=floor_torch_only"
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_CONTACT_RED]"
                    + " categoryScope=floor_torch_only"
                    + " caseName=lowered_full_block_support"
                    + " supportDy=" + String.format("%.3f", supportDy)
                    + " torchDy=" + (Double.isFinite(torchDy) ? String.format("%.3f", torchDy) : "N/A")
                    ...
                    + " wall_torch=NOT_COVERED"
                    + " productionGameplayFixApplied=true");
            String fixMarker = "[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_CONTACT_FIX_GREEN]";
            System.out.println(fixMarker
                    + " categoryScope=floor_torch_only"
                    + " caseName=lowered_full_block_support"
                    + " legalOutcome=" + legalOutcome
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_CONTACT_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " caseName=lowered_full_block_support"
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_REGRESSION_SUMMARY]"
                + " categoryScope=floor_torch_only"
        ...
        if (!topGreen || !bottomGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_FULL_BLOCK_REGRESSION_FAILED]"
    ...
    private static void runBeta35FloorTorchSupportFinalizationRedProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_FINALIZATION_RED]"
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_FINALIZATION_RED]"
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_FINALIZATION_RED]"
                    ...
                    + " wall_torch=NOT_COVERED"
                    + " productionGameplayFixApplied=true"
                    + " beta35ReleaseStatus=PAUSED_PENDING_MAINTAINER_RETEST");
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_FINALIZATION_GREEN]"
                    + " phase=after_finalization"
                    + " categoryScope=floor_torch_only"
                    + " torchPresent=" + torchPresent
                    + " legalOutcome=" + legalOutcome
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_FINALIZATION_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " legalOutcome=" + legalOutcomeHolder[0]
                + " failureLayer=" + failureLayerHolder[0]
                ...
                + " beta35ReleaseStatus=PAUSED_PENDING_MAINTAINER_RETEST"
                + " releasePrep=PAUSED"
                + " nextSlice=RELEASE_PENDING_MAINTAINER_RETEST");
    ...
    private static void runBeta35LiveFloorTorchContactGapRedProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_CONTACT_GAP_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
            placementResultText[0] = result.toString();
        ...
        ctx.runOnClient(mc -> {
            ...
            String marker = "[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_CONTACT_GAP_RED]";
            System.out.println("[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_CONTACT_GAP_MEASURED]"
                    + " categoryScope=floor_torch_only"
            ...
            System.out.println(marker
                    ...
                    + " proofTargetLayer=FLOOR_TORCH_ONLY");
        System.out.println("[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_CONTACT_GAP_SUMMARY]"
                + " categoryScope=floor_torch_only"
                + " itemCategory=floor_torch"
                + " wall_torch=NOT_COVERED"
                + " lantern=NOT_COVERED"
    ...
    private static void runBeta35LiveFloorTorchSourceTruthParityProof(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_SOURCE_TRUTH_FAIL]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
            ActionResult result = mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, torchUseHit);
            placementResultText[0] = result.toString();
        ...
        ctx.runOnClient(mc -> {
            ...
            // MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_SOURCE_AUDIT: diagnostic-only markers that log
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_SOURCE_AUDIT]"
                    + " categoryScope=floor_torch_only"
                    + " supportCandidatePos=" + supportCandidatePos.toShortString()
                    + " supportCandidateState=" + supportCandidateState
                    + " supportDy=" + String.format("%.3f", supportDy)
            ...
            if (!fixtureMatchesLiveDyStack) {
                ...
                System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_SOURCE_MISSING]"
                        + " categoryScope=floor_torch_only"
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SUPPORT_SOURCE_SUMMARY]"
                    + " categoryScope=floor_torch_only"
            ...
            String parityMarker = fixtureMatchesLiveDyStack
                    ? "[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_SOURCE_TRUTH_GREEN]"
                    : "[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_SOURCE_TRUTH_FAIL]";
            ...
            System.out.println("[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_CONTACT_GAP_RED]"
                    + " categoryScope=floor_torch_only"
                    + " itemCategory=floor_torch"
                    + " wall_torch=NOT_COVERED"
                    + " torchPos=" + torchPos.toShortString()
            ...
            System.out.println("[MAINTAINER_BETA35_LIVE_FLOOR_TORCH_SOURCE_TRUTH_SUMMARY]"
                    + " categoryScope=floor_torch_only"
                    + " wall_torch=NOT_COVERED"
                    + " anchoredFullBlockPos=" + anchoredFullBlockPos.toShortString()
                    + " anchoredFullBlockAnchored=" + belowSupportAnchored
    ...
    private static void runBeta35FloorTopObjectFamilyAudit(
        ...
        System.out.println("MAINTAINER_BETA35_FLOOR_TOP_OBJECT_MATRIX_START"
        ...
        System.out.println("MAINTAINER_BETA35_FLOOR_TOP_OBJECT_SUMMARY"
    ...
    private static void runBeta35CommonObjectCompatibilityAudit(
        ...
        System.out.println("MAINTAINER_BETA35_COMMON_OBJECT_MATRIX_START"
        ...
        System.out.println("MAINTAINER_BETA35_COMMON_OBJECT_SUMMARY"
    ...
    private static void runBeta35SpecialFullblockCompatibilityAudit(
        ...
        System.out.println("MAINTAINER_BETA35_SPECIAL_FULLBLOCK_MATRIX_START"
        ...
        System.out.println("MAINTAINER_BETA35_SPECIAL_FULLBLOCK_SUMMARY"
                + " rows=" + (cases.length * Beta35CommonObjectSupportCase.values().length)
                + " greenAlreadyInherits=" + green
                + " placementFailure=" + placementFailure
                + " survivalFailure=" + survivalFailure
    ...
    private static Beta35CommonObjectAuditResult runBeta35SpecialFullblockAuditRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                System.out.println("MAINTAINER_BETA35_SPECIAL_FULLBLOCK_ROW"
    ...
    private static void runBeta35ChestContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_CHEST_CONTACT_GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_CHEST_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:chest"
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_CHEST_CONTACT_RED"
                    + " objectId=minecraft:chest"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_CHEST_CONTACT_RED]"
    ...
    private static void runBeta35BarrelTriadProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_BARREL_TRIAD_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_BARREL_TRIAD_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:barrel"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_BARREL_TRIAD_RED"
                    + " objectId=minecraft:barrel"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_BARREL_TRIAD_RED]"
    ...
    private static void runBeta35EnchantingTableContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_ENCHANTING_TABLE_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_ENCHANTING_TABLE_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:enchanting_table"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_ENCHANTING_TABLE_CONTACT_RED"
                    + " objectId=minecraft:enchanting_table"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_ENCHANTING_TABLE_CONTACT_RED]"
    ...
    private static void runBeta35StonecutterContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_STONECUTTER_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_STONECUTTER_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:stonecutter"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_STONECUTTER_CONTACT_RED"
                    + " objectId=minecraft:stonecutter"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_STONECUTTER_CONTACT_RED]"
    ...
    private static void runBeta35AnvilContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_ANVIL_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_ANVIL_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:anvil"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_ANVIL_CONTACT_RED"
                    + " objectId=minecraft:anvil"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_ANVIL_CONTACT_RED]"
    ...
    private static void runBeta35GrindstoneContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_GRINDSTONE_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_GRINDSTONE_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:grindstone"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_GRINDSTONE_CONTACT_RED"
                    + " objectId=minecraft:grindstone"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_GRINDSTONE_CONTACT_RED]"
    ...
    private static void runBeta35BookshelfContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_BOOKSHELF_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_BOOKSHELF_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:bookshelf"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_BOOKSHELF_CONTACT_RED"
                    + " objectId=minecraft:bookshelf"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_BOOKSHELF_CONTACT_RED]"
    ...
    private static void runBeta35TrapdoorDoorAudit(
        ...
        System.out.println("MAINTAINER_BETA35_TRAPDOOR_DOOR_MATRIX_START"
        ...
        System.out.println("MAINTAINER_BETA35_TRAPDOOR_DOOR_SUMMARY"
    ...
    private static Beta35TrapdoorDoorAuditRow runBeta35TrapdoorAuditRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                System.out.println("MAINTAINER_BETA35_TRAPDOOR_DOOR_ROW"
    ...
    private static void runBeta35OakTrapdoorContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_OAK_TRAPDOOR_CONTACT_GREEN"
                        + " objectId=minecraft:oak_trapdoor"
                        + " family=interactive_hinge"
                        + " supportCase=" + supportCase
                        + " placement=GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_OAK_TRAPDOOR_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:oak_trapdoor"
                + " family=interactive_hinge"
                + " supportRows=2"
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_OAK_TRAPDOOR_CONTACT_RED]"
    ...
    private static void runBeta35OakDoorContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_OAK_DOOR_CONTACT_GREEN"
                        + " objectId=minecraft:oak_door"
                        + " family=multipart_door"
                        + " supportCase=" + supportCase
                        + " placement=GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_OAK_DOOR_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:oak_door"
                + " family=multipart_door"
                + " supportRows=2"
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_OAK_DOOR_CONTACT_RED]"
    ...
    private static void runBeta35StandingOakSignContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_STANDING_OAK_SIGN_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_STANDING_OAK_SIGN_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:oak_sign"
                + " family=standing_sign"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_STANDING_OAK_SIGN_CONTACT_RED"
                    + " objectId=minecraft:oak_sign"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_STANDING_OAK_SIGN_CONTACT_RED]"
    ...
    private static void runBeta35OakFenceContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_OAK_FENCE_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_OAK_FENCE_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:oak_fence"
                + " family=partial_collision"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
        ...
        if (!allGreen) {
            System.out.println("MAINTAINER_BETA35_OAK_FENCE_CONTACT_RED"
                    + " objectId=minecraft:oak_fence"
                    + " failureLayer=" + failureLayer
                    + " classification=RED");
            throw new RuntimeException("[MAINTAINER_BETA35_OAK_FENCE_CONTACT_RED]"
    ...
    private static void runBeta35FenceWallVariantCoverageProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_VARIANT_COVERAGE_GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_VARIANT_COVERAGE_SUMMARY"
    ...
    private static void runBeta35FenceModelRenderRedProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_MODEL_RENDER_RED"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_MODEL_RENDER_SUMMARY"
                ...
                + " canonicalCheckoutModified=false");
        if (!red) {
            System.out.println("MAINTAINER_BETA35_FENCE_MODEL_RENDER_GREEN"
                    + " outcome=GREEN"
                    + " variants=minecraft:oak_fence,minecraft:spruce_fence,minecraft:nether_brick_fence,minecraft:cobblestone_wall"
                    + " glass_pane=NOT_COVERED"
                    + " failureLayer=NONE"
    ...
    private static String runBeta35FenceModelRenderRedRow(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_MODEL_RENDER_ROW"
                + " objectId=" + objectCase.objectId()
                + " family=" + objectCase.family()
    ...
    private static void runBeta35BirchFenceVariantRedProof(
        ...
        System.out.println("MAINTAINER_BETA35_BIRCH_FENCE_VARIANT_RED"
        ...
        System.out.println("MAINTAINER_BETA35_BIRCH_FENCE_VARIANT_SUMMARY"
                + " outcome=" + (red ? "RED" : "GREEN")
                + " rows=" + rows
                ...
                + " canonicalCheckoutModified=false");
        if (!red) {
            System.out.println("MAINTAINER_BETA35_BIRCH_FENCE_VARIANT_GREEN"
                    + " outcome=GREEN"
    ...
    private static String runBeta35BirchFenceVariantRedRow(
        ...
        System.out.println("MAINTAINER_BETA35_BIRCH_FENCE_VARIANT_ROW"
                + " objectId=" + objectCase.objectId()
                + " family=" + objectCase.family()
                + " configuration=isolated"
    ...
    private static void runBeta35FenceWallFamilyFixProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_FAMILY_SUMMARY"
                + " outcome=" + (red ? "RED" : "GREEN")
                + " rows=" + rows
                ...
                + " canonicalCheckoutModified=false");
        if (!red) {
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_FAMILY_GREEN"
                    + " outcome=GREEN"
                    + " fenceFamilyRows=11"
                    + " wallFamilyRows=9"
    ...
    private static String runBeta35FenceWallFamilyFixRow(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_FAMILY_ROW"
                + " objectId=" + objectCase.objectId()
                + " family=" + objectCase.family()
    ...
    private static void runBeta35FenceWallContactHitboxProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_CONTACT_HITBOX_START"
        ...
        boolean proofGreen = rows == green
                ...
                && other == 0;
        String failureLayer = proofGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_CONTACT_HITBOX_SUMMARY"
                + " outcome=" + (proofGreen ? "GREEN" : "RED")
                + " rows=" + rows
                + " green=" + green
                + " contactGap=" + contactGap
                ...
                + " releaseTagMoved=false");
        if (proofGreen) {
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_CONTACT_HITBOX_GREEN"
                    + " rows=" + rows
                    + " wall=GREEN"
                    + " fence=GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_CONTACT_HITBOX_RED"
                + " rows=" + rows
                + " failureLayer=" + failureLayer
                + " contactGap=" + contactGap
                + " triadMismatch=" + triadMismatch
                + " ownerGap=" + ownerGap
                + " dyMismatch=" + dyMismatch);
        throw new RuntimeException("[MAINTAINER_BETA35_FENCE_WALL_CONTACT_HITBOX_RED]"
    ...
    private static String runBeta35FenceWallContactHitboxRow(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_CONTACT_HITBOX_ROW"
    ...
    private static void runBeta35FenceWallOwnerServerHitProof(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_OWNER_SERVER_HIT_ROW"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_OWNER_SERVER_HIT_SUMMARY"
                + " outcome=" + (proofGreen ? "GREEN" : "RED")
                + " previousFailureLayer=LIVE_OWNER_GAP_PLUS_SERVER_SHIFTED_HIT_TOLERANCE"
                + " failureLayer=" + failureLayerBox[0]
                ...
                + " releaseTagMoved=false");
        if (proofGreen) {
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_OWNER_SERVER_HIT_GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_OWNER_SERVER_HIT_RED"
                + " failureLayer=" + failureLayerBox[0]);
        throw new RuntimeException("[MAINTAINER_BETA35_FENCE_WALL_OWNER_SERVER_HIT_RED]"
                + " failureLayer=" + failureLayerBox[0]);
    }
    ...
    private static void runBeta35FenceWallStackContactProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_STACK_CONTACT_START"
        ...
        String failureLayer = proofGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_STACK_CONTACT_SUMMARY"
                + " outcome=" + (proofGreen ? "GREEN" : "RED")
                + " rows=" + rows
                + " green=" + green
                + " contactGap=" + contactGap
                ...
                + " releaseAudit=NOT_RUN"
                + " releaseTagMoved=false");
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_RESIDUAL_JANK_SUMMARY"
        ...
        if (proofGreen) {
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_STACK_CONTACT_GREEN"
                    + " wallOnWall=GREEN"
                    + " fenceOnFence=GREEN"
                    + " wallOnFence=GREEN"
                    + " fenceOnWall=GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_STACK_CONTACT_RED"
                + " failureLayer=" + failureLayer
                + " contactGap=" + contactGap
                + " triadMismatch=" + triadMismatch
                + " ownerGap=" + ownerGap);
        throw new RuntimeException("[MAINTAINER_BETA35_FENCE_WALL_STACK_CONTACT_RED]"
                + " failureLayer=" + failureLayer);
    }
    ...
    private static String runBeta35FenceWallStackContactRow(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_STACK_CONTACT_ROW"
    ...
    private static void runBeta35FenceWallVisualHitboxStackAimProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_START"
        ...
        String failureLayer = proofGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_SUMMARY"
                + " outcome=" + (proofGreen ? "GREEN" : "RED")
                + " rows=" + rows
        ...
        if (proofGreen) {
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_GREEN"
                    + " birchFence=VISUAL_HITBOX_GREEN"
                    + " connectedWall=COLLISION_OVERHANG_NOT_VISUAL_TRIAD"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_RED"
                + " failureLayer=" + failureLayer
                + " red=" + red
                + " torchSupportContactGap=" + torchSupportClassification);
        throw new RuntimeException("[MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_RED]"
                + " failureLayer=" + failureLayer);
    }
    ...
    private static String runBeta35FenceWallVisualHitboxStackAimRow(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_ROW"
                    + " rowIndex=" + rowIndex
                    + " rowId=" + rowId
    ...
    private static String runBeta35FenceWallTorchSupportNoiseRow(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("MAINTAINER_BETA35_FENCE_WALL_VISUAL_HITBOX_STACK_AIM_SUPPORT_ROW"
    ...
    private static void runBeta35SlabHeightHitAcceptanceRedProof(
        ...
        System.out.println("MAINTAINER_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE_RED"
        ...
        System.out.println("MAINTAINER_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE_SUMMARY"
                + " outcome=" + outcome
                + " rows=" + rowIndex
                + " green=" + green
                + " red=" + red
    ...
    private static Beta35SlabHeightHitAcceptanceRow runBeta35SlabHeightHitAcceptanceRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null || mc.gameRenderer == null) {
                ...
                System.out.println("MAINTAINER_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE_RED_ROW"
                        + " rowIndex=" + rowIndex
    ...
    private static void runBeta35LiveHitboxGateRedProof(
        ...
        System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_GATE_MATRIX_START"
        ...
        System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_GATE_SUMMARY"
                + " outcome=" + outcome
                + " rows=" + results.length
                + " red=" + red
                + " pending=" + pending
    ...
    private static void runBeta35LiveHitboxOwnerRedProof(
        ...
        System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_OWNER_RED"
        ...
        System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_OWNER_SUMMARY"
                + " outcome=" + outcome
                + " rows=" + results.length
                + " red=" + red
                + " pending=" + pending
        ...
        if ("GREEN".equals(outcome)) {
            System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_OWNER_GREEN"
                    + " rows=" + results.length
                    + " wall=GREEN"
                    + " fence=GREEN"
                    + " anvil=GREEN"
    ...
    private static Beta35LiveHitboxGateAuditResult beta35RunLiveHitboxOwnerRayRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null || mc.gameRenderer == null) {
                ...
                System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_OWNER_ROW"
                        + " objectId=" + objectId
                        + " family=" + family
    ...
    private static void runBeta35FenceGateContactProof(
        ...
        if (allGreen) {
            System.out.println("MAINTAINER_BETA35_FENCE_GATE_CONTACT_GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_GATE_CONTACT_SUMMARY"
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_FENCE_GATE_CONTACT_RED]"
    ...
    private static void runBeta35FenceGateFamilyFixProof(
        ...
        for (int i = 0; i < cases.length; i++) {
            ...
            Beta35LiveHitboxGateAuditResult closed = runBeta35FenceGateContactAuditRow(
                    ...
                    false,
                    780,
                    "MAINTAINER_BETA35_FENCE_GATE_FAMILY_ROW",
                    gateCase);
        ...
        if (allGreen) {
            System.out.println("MAINTAINER_BETA35_FENCE_GATE_FAMILY_GREEN"
                    + " family=fence_gate"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_GATE_FAMILY_SUMMARY"
                + " outcome=" + (allGreen ? "GREEN" : "RED")
                + " failureLayer=" + failureLayer
                + " variants=" + cases.length
                + " rows=" + rows
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_FENCE_GATE_FAMILY_RED]"
    ...
    private static Beta35LiveHitboxGateAuditResult runBeta35LiveFenceWallHitboxGateRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                classification[0] = "PENDING";
                failureLayer[0] = "LIVE_EVIDENCE_GAP";
                System.out.println("MAINTAINER_BETA35_LIVE_HITBOX_GATE_ROW"
                        + " objectId=" + objectCase.objectId()
                        + " family=" + objectCase.family()
    ...
    private static Beta35LiveHitboxGateAuditResult runBeta35LiveFenceGateRow(
        ...
        return runBeta35FenceGateContactAuditRow(
                ...
                openAfterPlacement,
                620,
                "MAINTAINER_BETA35_LIVE_HITBOX_GATE_ROW",
                new Beta35FenceGateFamilyCase("minecraft:cherry_fence_gate", Items.CHERRY_FENCE_GATE,
                        Blocks.CHERRY_FENCE_GATE, true));
    }
    ...
    private static Beta35LiveHitboxGateAuditResult runBeta35FenceGateContactRow(
        ...
        return runBeta35FenceGateContactAuditRow(
                ...
                openAfterPlacement,
                740,
                "MAINTAINER_BETA35_FENCE_GATE_CONTACT_ROW",
                new Beta35FenceGateFamilyCase("minecraft:cherry_fence_gate", Items.CHERRY_FENCE_GATE,
                        Blocks.CHERRY_FENCE_GATE, true));
    }
    ...
    private static void runBeta35FenceFamilyLiveRedProof(
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_FAMILY_LIVE_RED"
        ...
        System.out.println("MAINTAINER_BETA35_FENCE_FAMILY_SUMMARY"
    ...
    private static Beta35FenceFamilyAuditResult runBeta35FenceFamilyAuditRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                System.out.println("MAINTAINER_BETA35_FENCE_FAMILY_ROW"
                        + " objectId=" + objectCase.objectId()
                        + " family=" + objectCase.family()
                        + " configuration=" + configuration.id
    ...
    private static void runBeta35FurnaceTriadProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_FURNACE_TRIAD_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_FURNACE_TRIAD_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:furnace"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
    ...
    private static void runBeta35CraftingTableContactProof(
        ...
        for (Beta35CommonObjectSupportCase supportCase : Beta35CommonObjectSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_CRAFTING_TABLE_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_CRAFTING_TABLE_CONTACT_SUMMARY"
                + " failureLayer=" + failureLayer
                + " objectId=minecraft:crafting_table"
                + " rows=" + Beta35CommonObjectSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_CRAFTING_TABLE_CONTACT_RED]"
    ...
    private static Beta35CommonObjectAuditResult runBeta35CommonObjectAuditRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                System.out.println("MAINTAINER_BETA35_COMMON_OBJECT_ROW"
                        + " objectId=" + objectCase.objectId()
                        + " family=" + objectCase.family()
                        + " itemId=" + objectCase.item()
                        + " supportCase=" + supportCase
    ...
    private static void runBeta35CandleFloorTopContactProof(
        ...
        for (Beta35FloorTopSupportCase supportCase : Beta35FloorTopSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_CANDLE_FLOOR_TOP_CONTACT_GREEN"
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_CANDLE_FLOOR_TOP_CONTACT_SUMMARY"
                + " objectId=minecraft:candle"
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_CANDLE_FLOOR_TOP_CONTACT_RED]"
    ...
    private static void runBeta35FlowerPotFloorTopSurvivalProof(
        ...
        for (Beta35FloorTopSupportCase supportCase : Beta35FloorTopSupportCase.values()) {
            ...
            if (survivalGreen) {
                System.out.println("MAINTAINER_BETA35_FLOWER_POT_FLOOR_TOP_SURVIVAL_GREEN"
        ...
        System.out.println("MAINTAINER_BETA35_FLOWER_POT_FLOOR_TOP_SURVIVAL_SUMMARY"
                + " objectId=minecraft:flower_pot"
                + " rows=" + Beta35FloorTopSupportCase.values().length
        ...
        if (!survivalRowsGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_FLOWER_POT_FLOOR_TOP_SURVIVAL_RED]"
    ...
    private static void runBeta35FlowerPotFloorTopContactProof(
        ...
        for (Beta35FloorTopSupportCase supportCase : Beta35FloorTopSupportCase.values()) {
            ...
            if (rowGreen) {
                System.out.println("MAINTAINER_BETA35_FLOWER_POT_FLOOR_TOP_CONTACT_GREEN"
                        + " objectId=minecraft:flower_pot"
                        + " supportCase=" + supportCase
        ...
        String failureLayer = allGreen ? "NONE" : firstFailureLayer;
        System.out.println("MAINTAINER_BETA35_FLOWER_POT_FLOOR_TOP_CONTACT_SUMMARY"
                + " objectId=minecraft:flower_pot"
                + " rows=" + Beta35FloorTopSupportCase.values().length
                + " expectedRowsGreen=" + allGreen
                + " failureLayer=" + failureLayer
        ...
        if (!allGreen) {
            throw new RuntimeException("[MAINTAINER_BETA35_FLOWER_POT_FLOOR_TOP_CONTACT_RED]"
    ...
    private static Beta35FloorTopObjectAuditResult runBeta35FloorTopObjectAuditRow(
        ...
        ctx.runOnClient(mc -> {
            if (mc.world == null || mc.player == null) {
                ...
                System.out.println("MAINTAINER_BETA35_FLOOR_TOP_OBJECT_ROW"
                        + " objectId=" + objectCase.objectId()
                        + " itemId=" + objectCase.item()
                        + " supportCase=" + supportCase
    ...
    private static ActionResult beta35PlaceForLiveSbsbsCapture(
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_SOURCE_TRUTH_RED]"
    ...
    private static void runBeta35FloorTorchSbsbsRedProof(
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_FIXTURE_GREEN]"
                    + " structure=SBSBS"
                    + " categoryScope=floor_torch_only"
                    + " supportPos=" + supportPos.toShortString()
                    + " supportState=" + supportState
        ...
        if (!sourceTruthCapture && fixtureFailureHolder[0] != null) {
            throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_FIXTURE_GREEN]"
        ...
        ctx.runOnClient(mc -> {
            if (mc.player == null || mc.interactionManager == null || mc.world == null) {
                throw new RuntimeException("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_RED]"
                        + " reason=client_not_ready categoryScope=floor_torch_only");
            }
        ...
        ctx.runOnClient(mc -> {
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_MEASURED]"
                    + " structure=SBSBS"
                    + " categoryScope=floor_torch_only"
                    + " torchPos=" + torchPos.toShortString()
                    + " torchState=" + torchState
                    ...
                    + " failureLayer=" + failureLayer
                    + " wall_torch=NOT_COVERED"
                    + " beta35ReleaseStatus=PAUSED_MAINTAINER_SBSBS_UNRESOLVED");

            if (sourceTruthCapture) {
                System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_SOURCE_TRUTH_MEASURED]"
                        + " structure=SBSBS"
                        + " categoryScope=floor_torch_only"
                        + " torchPos=" + torchPos.toShortString()
                        + " torchState=" + torchState
            ...
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_RED]"
        ...
        System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_SUMMARY]"
                + " structure=SBSBS"
                + " categoryScope=floor_torch_only"
                + " failureLayer=" + failureLayerHolder[0]
                + " isVanillaPosition=" + isVanillaPositionHolder[0]
                + " redProofResult=" + (proofRed ? "RED" : "GREEN")
                + " maintainerLiveReport=SBSBS_TORCH_FLOATS_VANILLA_POSITION"
                + " productionGameplayFixApplied=true"
                + " wall_torch=NOT_COVERED"
                + " lantern=NOT_COVERED"
                + " signs=NOT_COVERED"
        ...
        if (sourceTruthCapture) {
            System.out.println("[MAINTAINER_BETA35_FLOOR_TORCH_SBSBS_SOURCE_TRUTH_SUMMARY]"
                    + " structure=SBSBS"
                    + " categoryScope=floor_torch_only"
                    + " supportPos=" + supportPos.toShortString()
                    + " torchPos=" + torchPos.toShortString()
