...
public final class SlabbedLabLoweredSidePlacementLiveReproClientGameTest implements FabricClientGameTest {
    ...
    private static void runMaintainerBeta4AboveAngleTargetingOwnerSplitRedCase(
        ...
        runMaintainerBeta4AngleTargetingProbe(
                ctx,
                singleplayer,
                "ground_front",
                supportPos,
    ...
    private static void runMaintainerBeta4AngleTargetingProbe(
            ClientGameTestContext ctx,
            TestSingleplayerContext singleplayer,
            String angle,
            BlockPos supportPos,
    ...
    private static void runMaintainerBeta4AngleTargetingProbe(
        ...
        ctx.runOnClient(mc -> {
            ...
            throw new RuntimeException("[MAINTAINER_BETA4_ABOVE_ANGLE_RED]" + facts
