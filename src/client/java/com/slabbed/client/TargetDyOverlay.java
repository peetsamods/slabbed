...
/**
 * Dev HUD readout of the crosshair-targeted block: position, name, source classification
 * (vanilla / Terrain Slabs + surface kind / other mod), the visual dy from
 * {@link SlabSupport#getYOffset}, and LOWERED / RAISED / flush + hit side.
 *
 * <p>Toggle in-game with {@code /slabdy}. Defaults on with {@code -Dslabbed.targetDyOverlay=true}.
 * Uses the (deprecated-but-present) {@code HudRenderCallback} — fine for a dev-only, flag-gated
 * diagnostic.
 */
