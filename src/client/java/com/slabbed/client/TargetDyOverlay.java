...
/**
 * Dev HUD readout of the crosshair-targeted block: position, name, namespace
 * (vanilla / Terrain Slabs + surface classification / other mod), the visual dy from
 * {@link SlabSupport#getYOffset}, and whether it is LOWERED / RAISED / flush.
 *
 * <p>Toggle in-game with {@code /slabdy} (see {@code SlabbedClient}). Defaults on when
 * launched with {@code -Dslabbed.targetDyOverlay=true}.
 */
