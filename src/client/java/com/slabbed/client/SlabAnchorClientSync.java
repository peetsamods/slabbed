...
public final class SlabAnchorClientSync {
    ...
    private static void onChunkLoad(ClientWorld world, WorldChunk chunk) {
        ...
        Long2ByteOpenHashMap initialDy = chunk.getAttached(SlabAnchorAttachment.PLACEMENT_DY_TYPE);
    ...
    private static void logCompoundVisibleClientSync(
        ...
        Slabbed.LOGGER.info(
                "[MAINTAINER_BETA4_COMPOUND_VISIBLE_RENDER_TRACE_CLIENT_SYNC] event={} pos=chunk marker={} serverMarker=n/a clientMarker={} modelViewType=World slabSupportDy=n/a clientDy=n/a candidateRerenderScheduled={} neighborRerenderScheduled={}",
                event,
                type,
                newPresent,
                newPresent,
    ...
    private static void logCompoundVisibleRenderRefresh(
        ...
        Slabbed.LOGGER.info(
                "[MAINTAINER_BETA4_COMPOUND_VISIBLE_RENDER_TRACE_RERENDER] pos={} marker={} serverMarker=n/a clientMarker={} modelViewType=World slabSupportDy={} clientDy={} candidateRerenderScheduled=true neighborRerenderScheduled=true sourceRerenderScheduled=true",
                pos.toShortString(),
                marker,
                clientMarker,
                slabSupportDy,
        ...
        Slabbed.LOGGER.info(
                "[MAINTAINER_BETA4_COMPOUND_VISIBLE_RENDER_TRACE_SUMMARY] classification=RERENDER_NOT_SCHEDULED pos={} marker={} markerSet=clientAttachment clientMarker={} modelDy={} candidateRerenderScheduled=true neighborRerenderScheduled=true releaseBlockers=MaintainerLiveRetest",
                pos.toShortString(),
                marker,
                clientMarker,
                slabSupportDy);
