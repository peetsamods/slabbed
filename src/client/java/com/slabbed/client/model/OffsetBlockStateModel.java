...
public final class OffsetBlockStateModel implements BlockStateModel, FabricBlockStateModel {
     ...
     */
    @Override
    public void emitQuads(@NonNull QuadEmitter emitter, @NonNull BlockRenderView view, @NonNull BlockPos pos, @NonNull BlockState state, @NonNull Random random, @NonNull Predicate<Direction> cullTest)
    {
        ...
        wrapped.emitQuads(out, view, pos, state, random, cullTest);
    }
}
