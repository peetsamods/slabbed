...
public final class SlabAnchorAttachment {
    ...
    private static void logCompoundVisibleRenderTraceMarkerSet(
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA4_COMPOUND_VISIBLE_RENDER_TRACE_MARKER_SET] action={} pos={} marker={} label={} serverMarker={} clientMarker=n/a modelViewType=World slabSupportDy={} clientDy=n/a candidateRerenderScheduled=false neighborRerenderScheduled=false",
                action,
                pos.toShortString(),
    ...
    private static void logCompoundVisibleRenderTraceSupportUpdate(
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA4_COMPOUND_VISIBLE_RENDER_TRACE_SUPPORT_UPDATE] pos={} marker=lowered_slab_carrier serverMarker={} clientMarker=n/a modelViewType=World slabSupportDy={} clientDy=n/a candidateRerenderScheduled=false neighborRerenderScheduled=false",
                pos.toShortString(),
                qualifies,
                dy);
    }
