...
public final class Beta35FenceWallLiveInspectRecorder {
    ...
    public static void logStartup(World world, PlayerEntity player) {
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_FENCE_WALL_LIVE_INSPECT] enabled=true phase=startup flag=-D{}=true world={} player={} scope=FenceBlock_WallBlock_anvil diagnosticsOnly=true releaseAudit=NOT_RUN releaseTagMoved=false",
                FLAG,
    ...
    public static void recordNoTarget(World world, PlayerEntity player, HitResult finalTarget) {
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_FENCE_WALL_LIVE_INSPECT] phase=client-tick classification=TRACE_ACTIVE_NO_TARGET failureLayer=TRACE_ACTIVE_NO_TARGET heldItem={} finalTarget=null",
    ...
    public static void recordClientTarget(
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_FENCE_WALL_LIVE_INSPECT] phase=client-crosshair"
    ...
    private static void recordTraceActiveNoTarget(
        ...
        lastNoTargetWorldTime = now;
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_FENCE_WALL_LIVE_INSPECT] phase=client-crosshair classification=TRACE_ACTIVE_NO_TARGET failureLayer=TRACE_ACTIVE_NO_TARGET heldItem={} initialTarget={} finalTarget={} finalDecision={} player={}",
                heldItemId(held),
