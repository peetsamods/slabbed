...
public final class Beta35SlabJumpSourceTruthRecorder {
    ...
    public static void recordAnchorEvent(
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_JUMP_ANCHOR_EVENT] action={} marker={} pos={} oldState={} newState={} reason={} worldSide={}",
                action.name(),
                marker.name(),
                pos.toShortString(),
    ...
    public static void logDySample(String rowPhase, String rowId, DySample before, DySample after,
        ...
        if (!isEnabled()) return;
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_JUMP_DY_SAMPLE] rowPhase={} rowId={} pos={} state={} dyBefore={} dyAfter={} "
    ...
    public static void logRow(String rowPhase, String rowId, BlockPos brokenOrPlacedPos,
        ...
        if (!isEnabled()) return;
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_JUMP_SOURCE_TRUTH] rowPhase={} rowId={} brokenOrPlacedPos={} "
    ...
    public static void logSummary(
        ...
        if (!isEnabled()) return;
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_JUMP_SUMMARY] rows={} sourceMarkerRemovedRows={} "
