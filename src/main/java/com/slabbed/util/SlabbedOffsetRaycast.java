 ...
 * ({@link SlabSupport#getYOffset} returns one of {@code -1.0, -0.5, 0.0, +0.5})
 ...
 * gametests in {@code SlabbedLabFixtureTest} pin both extremes so a future
...
public final class SlabbedOffsetRaycast {
     ...
     * shape raycast per position, and memoises {@code getYOffset} so a shared
