...
public final class RuntimeDiagnostics {
    ...
    private static volatile boolean renderStepCullTraceSeen;
    private static volatile boolean renderStepCullTraceRelaxed;
    ...
    public static void resetRenderStepCullTrace(BlockPos pos) {
        renderStepCullTracePos = pos == null ? Long.MIN_VALUE : pos.asLong();
        renderStepCullTraceSeen = false;
        renderStepCullTraceRelaxed = false;
    }

    public static void recordRenderStepCullTrace(BlockPos pos, boolean relaxed) {
        if (pos == null || pos.asLong() != renderStepCullTracePos) {
            return;
        }
        renderStepCullTraceSeen = true;
        renderStepCullTraceRelaxed = relaxed;
    }

    public static boolean renderStepCullTraceSeen() {
        return renderStepCullTraceSeen;
    }

    public static boolean renderStepCullTraceRelaxed() {
        return renderStepCullTraceRelaxed;
    }
}
