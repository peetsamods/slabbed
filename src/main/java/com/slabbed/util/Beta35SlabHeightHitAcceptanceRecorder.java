...
public final class Beta35SlabHeightHitAcceptanceRecorder {
    ...
    public static void logStartup(World world, PlayerEntity player) {
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE] enabled=true phase=startup flag=-D{}=true world={} player={} scope=generic_held_item_visible_target diagnosticsOnly=true releaseAudit=NOT_RUN releaseTagMoved=false allItemClaim=false",
                FLAG,
    ...
    public static void recordNoTarget(World world, PlayerEntity player, HitResult finalTarget) {
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE_SAMPLE] phase=client-tick classification=TRACE_ACTIVE_NO_TARGET failureLayer=TRACE_ACTIVE_NO_TARGET heldItem={} heldItemCategory={} finalTarget=null diagnosticsOnly=true",
    ...
    public static void recordClientTarget(
        ...
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE_SAMPLE]"
    ...
    private static void logTraceActive(
        ...
        lastNoTargetWorldTime = now;
        Slabbed.LOGGER.info(
                "[SLABBED_BETA35_SLAB_HEIGHT_HIT_ACCEPTANCE_SAMPLE] phase=client-crosshair classification=TRACE_ACTIVE_NO_TARGET failureLayer=TRACE_ACTIVE_NO_TARGET heldItem={} heldItemCategory={} initialTarget={} finalTarget={} finalDecision={} player={} diagnosticsOnly=true",
                heldItemId(held),
                heldItemCategory(held),
