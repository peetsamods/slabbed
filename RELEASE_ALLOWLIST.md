...
| `com/slabbed/mixin/client/*` | The 13 client render/interaction mixins declared in `slabbed.client.mixins.json`; every member is a render-offset, remesh, entity-light or offset-raycast mixin. |
