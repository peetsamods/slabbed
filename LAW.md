...
- Any lane that re-derives a height from neighbours on read — including the pre-0.5 recompute
  behind the `-Dslabbed.frozenDy=false` escape hatch — is outside this law. It exists only for
