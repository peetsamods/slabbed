...
## Law corollary — hung and wall-mounted things remember too (maintainer ruling, 2026-09-13)
...
- Any lane that re-derives a height from neighbours on read — on this line, the legacy lanes that
  answer for a cell carrying no stored placement fact — is outside this law. It exists only for
  worlds older than the store and is not a second definition of correct behaviour.
