...
3. **Live play-testing** by the maintainer (Maintainer) via the Modrinth `Slabbed+Terrain Slabs` profile.
...
_Decision: Maintainer, 2026-06-14. Companion detail in `HANDOFF.md` (top section) and `SLABBED_SPINE.md`._
