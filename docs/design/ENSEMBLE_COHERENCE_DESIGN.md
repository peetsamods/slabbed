...
in the maintainer's tower was individually lawful — 30 breaks, zero pops, sentinel green with liveness proof —
while the ensemble read as "everything falling apart."

## Laws in tension (both the maintainer's, both standing)
